        ...
        <div class="card-body">
            <form action="{{route('storeShop')}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="shop" placeholder="Enter Shop Number" name="shop" required>
                </div>
                <div class="form-group">
                    <label for="shopHeight">Shop Height</label>
                    <input type="number" class="form-control" id="shopHeight" placeholder="Enter Shop Height(Square)" name="shopHeight" required>
                </div>
                <div class="form-group">
                    <label for="shopWidth">Shop Width</label>
                    <input type="number" class="form-control" id="shopWidth" placeholder="Enter Shop Width(Square)" name="shopWidth" required>
                </div>
